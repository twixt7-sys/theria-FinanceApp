        ...
        <div className='grid grid-cols-3 gap-2'>
          ...
          <div className='col-span-2 space-y-2'>
            ...
            >
              <div className="pl-6">
                {accountId ? (
                  <IconComponent name={getAccountDetails().iconName} className='mr-3' size={14} style={{ color: getAccountDetails().color }} />
                ) : (
                  <Wallet className='mr-3' size={14} />
                )}
              </div>
              <div className="flex flex-col items-center flex-1">
                <span className="text-[8px] text-muted-foreground mb-0.5">Choose Account</span>
                <span className="text-[10px] font-medium truncate">{getAccountName()}</span>
              </div>
            </button>
