    ...
    <>
      ...
      <div className="grid grid-cols-3 gap-3">
        ...
        <button
          ...
          className="w-full flex items-center gap-2 px-4 py-3 rounded-lg border border-border hover:bg-muted transition-colors text-sm font-medium p-1 col-span-1 justify-center"
        >
