...
export const StreakScreen: React.FC = () => {
  ...
  return (
    <div className="space-y-3 pb-6 max-w-4xl mx-auto">
      ...
      <div className="bg-gradient-to-r from-orange-500 to-orange-600 rounded-xl p-4.5 text-white shadow-sm">
        <div className="text-center">
          ...
          <h1 className="text-2xl font-bold mb-1">{currentStreak}</h1>
          <p className="text-base font-medium opacity-90">Day Streak</p>
          <p className="text-xs opacity-75 mt-1.5">Keep it going! You're on fire 🔥</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-2.5">
        <div className="bg-card rounded-xl border border-border p-3.5 shadow-sm">
          <div className="flex items-center gap-2.5 mb-2.5">
            ...
            <h3 className="text-sm font-semibold text-foreground">Longest</h3>
          </div>
        ...
        <div className="bg-card rounded-xl border border-border p-3.5 shadow-sm">
          <div className="flex items-center gap-2.5 mb-2.5">
            ...
            <h3 className="text-sm font-semibold text-foreground">Total Days</h3>
          </div>
        ...
        <div className="bg-card rounded-xl border border-border p-3.5 shadow-sm">
          ...
          <p className="text-lg font-bold text-foreground">{monthlyProgress}/{monthlyGoal}</p>
          <p className="text-xs text-muted-foreground">days</p>
        </div>
      </div>
      ...
      <div className="bg-card rounded-xl border border-border p-4 shadow-sm">
        <div className="flex items-center gap-2.5 mb-3">
          ...
          <h3 className="text-base font-semibold text-foreground">Monthly Progress</h3>
        </div>
      ...
      <div className="bg-gradient-to-r from-orange-50 to-yellow-50 dark:from-orange-900/20 dark:to-yellow-900/20 rounded-xl border border-orange-200 dark:border-orange-800 p-4">
        <div className="text-center">
          <h3 className="text-base font-semibold text-orange-800 dark:text-orange-200 mb-1.5">
